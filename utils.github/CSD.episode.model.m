...
iteration_number = 5; % Choose how many iterations/timesteps/intervals you would like to calculate the model for
...
start_node = 1531; %Region V3A
end_node = 5715; %Region V5
...
% for i = 1:size(unique_adjacent_nodes,1)
%     text(brain_mesh.Points(unique_adjacent_nodes(i,1),1),brain_mesh.Points(unique_adjacent_nodes(i,1),2),brain_mesh.Points(unique_adjacent_nodes(i,1),3),num2str(i), 'Color','w','FontSize',20);
% end
